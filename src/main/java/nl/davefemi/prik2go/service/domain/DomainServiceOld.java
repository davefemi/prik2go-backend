...
public class DomainServiceOld {
        private static final Logger logger = Logger.getLogger(DomainServiceOld.class.getName());
        private static final Log log = LogFactory.getLog(DomainServiceOld.class);
